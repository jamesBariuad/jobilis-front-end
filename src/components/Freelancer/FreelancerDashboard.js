...
const FreelancerDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://jobilis-api.onrender.com/api/users/freelancer-dashboard/${id}`)
      .then((res) => {
  ...
  const handleAcceptClick = (e) => {
    setIdToDelete(e.target.id);
    console.log(id)
    // axios.put(`https://jobilis-api.onrender.com/api/users/${idToDelete}`,).then(setRerender(rerender + 1))
  }
