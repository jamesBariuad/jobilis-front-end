...
const RecruiterDashboard = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://jobilis-api.onrender.com/api/users/recruiter-dashboard/${id}`)
      .then((res) => {
  ...
  const handleSecondDeleteClick = () => {
    axios
      .delete(`https://jobilis-api.onrender.com/api/users/${idToDelete}`)
                        ...
                        {service?.map((recruit) => (
                          ...
                          >
                            ...
                            <TableCell component="th" scope="row">
                              {`${recruit.freelancerId?.firstName} ${recruit.freelancerId?.lastName}`}
                            </TableCell>
                            <TableCell align="center">
                              {recruit.service}
                            </TableCell>
                            ...
                            <TableCell align="center">
                              {recruit?.freelancerId?.contact}
                            </TableCell>
                            <TableCell align="center">
                              {recruit?.freelancerId?.ratings}
                            </TableCell>
                            <TableCell align="center">
                              {recruit.status}
                            </TableCell>
      ...
      {toggleModal ? (
        <div className={styles2.modal}>
          <div className={styles2.modalcontent}>
            <b>
              Are you sure you want to cancel booking entry?
              <br></br>
              (this cant be undone)
            </b>
