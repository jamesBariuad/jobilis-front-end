...
const Jobpostings = () => {
  ...
  useEffect(() => {
    axios.get('https://jobilis-api.onrender.com/api/users/'+ localStorage.userEmail)
    .then(res =>{
  ...
  const handleSubmit = (e) =>{
    ...
    if(selectedService === "Babysitter"){
      axios.put('https://jobilis-api.onrender.com/api/users/babysitter-input/'+ localStorage.userEmail, userData )
    ...
    if(selectedService === "Laundress"){
      axios.put('https://jobilis-api.onrender.com/api/users/laundress-input/'+ localStorage.userEmail, userData )
      .then(res =>{console.log(res.data)})
      setOpenForm(false)
      alert("Details Updated Successfully!")
    }
    if(selectedService === "Cleaner"){
      axios.put('https://jobilis-api.onrender.com/api/users/cleaner-input/'+ localStorage.userEmail, userData )
			  .then(res =>{console.log(res.data)})
        setOpenForm(false)
        alert("Details Updated Successfully!")
    }
        ...
        <div className="flex card-container">
          <div className="card flex-column ">
            ...
            <Switch
              ...
              onChange={()=>{ 
                ...
                axios.put('https://jobilis-api.onrender.com/api/users/activate-babysitter/'+ localStorage.userEmail, {active: !babySitter} )
			          .then(res =>{console.log(res.data)})
              }}
          ...
          <div className="card flex-column ">
            ...
            <Switch
              ...
              onChange={()=>{ 
                ...
                axios.put('https://jobilis-api.onrender.com/api/users/activate-laundress/'+ localStorage.userEmail, {active: !laundress} )
			          .then(res =>{console.log(res.data)})
               }}
              inputProps={{ 'aria-label': 'controlled' }}
          ...
          <div className="card flex-column">
            ...
            <Switch
              ...
              onChange={()=>{
                setCleaner(!cleaner)
                axios.put('https://jobilis-api.onrender.com/api/users/activate-cleaner/'+ localStorage.userEmail, {active: !cleaner} )
			          .then(res =>{console.log(res.data)})
               }}
              inputProps={{ 'aria-label': 'controlled' }}
